...
import kit.ipe.adl.instruments.nivisa.keysight.KeysightHarvester
...
object VISAHarvester extends Harvester {
  ...
  override def doHarvest = {
    ...
    VisaLibrary.viFindRsrc(VISA.getResourceManagerHandler, Pointer.pointerToCString("USB?*INSTR"), instrsList, numInstr, resourceString) match {
